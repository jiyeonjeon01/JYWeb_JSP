...
public class LogoutBoardVO {
	...
	public String toString() {
		return "LogoutBoardVO [num=" + num + ", writer=" + writer + ", email=" + email + ", pass=" + pass + ", title="
				+ title + ", readCount=" + readCount + ", regDate=" + regDate + ", content=" + content + ", ref=" + ref
