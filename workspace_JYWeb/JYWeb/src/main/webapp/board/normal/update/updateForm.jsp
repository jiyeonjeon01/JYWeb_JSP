    ...
    <main>
        ...
        <section>
            <article class="update-board-article">
                ...
                <form action="<%=request.getContextPath()%>/board/normal/update/updateProc.jsp" method="post" enctype="multipart/form-data" class="update-board-form">
                    ...
                    <div class="update-board-button-group">
                        ...
                        <button type="button" class="update-board-cancel" onclick="location.href='<%=request.getContextPath()%>/board/normal/normalShow.jsp?num=<%= post.getNum() %>&pageNum=<%= pageNum %>'">취소</button>
                    </div>
                </form>
            </article>
        </section>
