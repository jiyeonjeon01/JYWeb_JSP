...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/board/normal/write/normalForm.css">
</head>
<body>
<article>
    <h2>자유게시판 글쓰기</h2>
    <form name="writeForm" method="post" action="normalProc.jsp" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <table>
            ...
            <tr>
                <th>내용</th>
                <td>
                    <textarea name="content" rows="10" maxlength="1000"></textarea>
                </td>
            </tr>
            <tr>
                <th>첨부파일</th>
...
<article class="write-board-article">
    ...
    <form name="writeForm" method="post" action="normalProc.jsp" enctype="multipart/form-data" onsubmit="return validateForm()" class="write-board-form">
        ...
        <div class="write-board-button-group">
            ...
            <input type="button" value="목록" class="write-board-list" onclick="window.location='<%=request.getContextPath()%>/board/normal/normalList.jsp'">
        </div>
    </form>
</article>
