                    ...
                    <tr>
                        <td colspan="2" class="logoutQShowBtnTd">
                         <div class="logoutQShowBtnWrapper">
                            ...
                            <button class="logoutQShowBtn" onclick="document.location.href='<%=request.getContextPath()%>/board/qna/question/logout/delete/deleteProc.jsp?num=<%= num %>&pageNum=<%= pageNum %>'">삭제하기</button>
